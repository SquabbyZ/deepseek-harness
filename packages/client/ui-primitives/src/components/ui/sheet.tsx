// Shadcn-style Sheet (Radix dialog): side-anchored panel with top/bottom/left/right variants.
...
const SheetContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SheetPrimitive.Content> & { side?: SheetSide; hideClose?: boolean }
>(({ side = 'right', className, children, hideClose = false, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    <SheetPrimitive.Content
      ref={ref}
      className={cn('fixed z-50 gap-4 bg-background p-6 shadow-lg', SHEET_SIDES[side], className)}
      {...props}
    >
      {children}
      {!hideClose && (
