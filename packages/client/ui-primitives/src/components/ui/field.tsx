// Shadcn-style Field: labelled form-field group (fieldset/legend/label/error).
...
const FieldLegend = React.forwardRef<
  HTMLLegendElement,
  React.ComponentPropsWithoutRef<'legend'> & { variant?: FieldLegendVariant }
...
const FIELD_ORIENTATIONS: Record<FieldOrientation, string> = {
...
const Field = React.forwardRef<
  HTMLDivElement,
  React.ComponentPropsWithoutRef<'div'> & { orientation?: FieldOrientation }
>(({ className, orientation = 'vertical', ...props }, ref) => (
  <div
    ...
    className={cn(FIELD_BASE, FIELD_ORIENTATIONS[orientation], className)}
    {...props}
  />
))
