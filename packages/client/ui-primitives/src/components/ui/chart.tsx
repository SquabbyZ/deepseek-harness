// Shadcn-style Chart: recharts wrapper + minimal chart-config context. Chart
// colors come from the config (`color: 'var(--chart-N)'`); ChartStyle emits the
// `--color-<key>` custom properties that recharts fills reference.
...
function getPayloadConfigFromPayload(
  ...
  if (typeof item[key] === 'string') {
    ...
    configLabelKey = item.payload[key] as string
  }
