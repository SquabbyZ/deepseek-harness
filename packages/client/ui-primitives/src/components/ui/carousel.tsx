// Shadcn-style Carousel: embla-carousel-react with previous/next controls.
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        {...props}
      >
        <IconChevronLeftOutline14 className="size-4" />
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        {...props}
      >
        <IconChevronRightOutline14 className="size-4" />
