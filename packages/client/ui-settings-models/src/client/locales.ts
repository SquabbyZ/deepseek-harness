...
export const en = {
  ...
  providerEmpty: 'No providers match.',
  close: 'Close',
  cancel: 'Cancel',
  apply: 'Apply',
  applying: 'Applying…',
  ...
  creating: 'Creating\u2026',
  emptyTitle: 'Configure a model to start exploring',
  emptyBody: 'Harness needs a usable model provider to run. Configure DeepSeek first, or add another provider.',
  emptyPrimary: 'Configure DeepSeek',
  emptySecondary: 'Add another provider',
  ...
  onboardingDescription: 'Choose a model provider and configure its key to start building.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  create: '创建提供方',
  creating: '创建中\u2026',
  emptyTitle: '配置模型，开始探索',
  emptyBody: 'Harness 需要一个可用的模型提供方才能运行。先配置 DeepSeek，或添加其他提供方。',
  emptyPrimary: '配置 DeepSeek',
  emptySecondary: '添加其他提供方',
  ...
  onboardingDescription: '选择一个模型提供方并配置其密钥，即可开始使用。',
