...
export const zh = {
  ...
  detailsBodyMissing: '该技能未提供 SKILL.md 正文。',
  detailsSource: '来源',
  detailsProvider: '提供方',
  detailsInvocation: '调用策略',
  detailsInvocationModel: '模型可调用',
  detailsInvocationUser: '用户可调用',
  detailsState: '当前状态',
  detailsStateEnabled: '已启用',
  detailsStateDisabled: '已禁用',
  detailsWhenToUse: '何时使用',
...
export const en = {
  ...
  detailsBodyMissing: 'No SKILL.md body available for this skill.',
  detailsSource: 'Source',
  detailsProvider: 'Provider',
  detailsInvocation: 'Invocation',
  detailsInvocationModel: 'Model invocable',
  detailsInvocationUser: 'User invocable',
  detailsState: 'State',
  detailsStateEnabled: 'Enabled',
  detailsStateDisabled: 'Disabled',
  detailsWhenToUse: 'When to use',
