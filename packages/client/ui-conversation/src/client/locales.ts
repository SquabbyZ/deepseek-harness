...
export const zh = {
  ...
  'settings.autoCompact.title': '自动压缩',
  'settings.autoCompact.description': '上下文接近上限时自动压缩对话历史',
  'settings.autoCompact.warn.title': '上下文预警',
  'settings.autoCompact.warn.description': '完成当前任务后、进入下一任务前，占用达到阈值时触发',
  'settings.autoCompact.redline.title': '上下文红线',
  'settings.autoCompact.redline.description': '当前任务在安全节点中断时，占用达到阈值时立即压缩',
...
export const en = {
  ...
  'image.remove': 'Remove attachment {name}',
  ...
  'settings.autoCompact.title': 'Auto compact',
  'settings.autoCompact.description': 'Automatically compact conversation history as context fills up',
  'settings.autoCompact.warn.title': 'Context warning',
  'settings.autoCompact.warn.description': 'Compact between tasks once usage reaches the threshold',
  'settings.autoCompact.redline.title': 'Context red line',
  'settings.autoCompact.redline.description': 'Compact immediately at the next safe stop once usage reaches the threshold',
