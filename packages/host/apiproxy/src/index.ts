...
export type { WebRoute, WebUpgradeRoute, WebRouteKind } from './web-types.ts'
...
export class ApiProxyService extends Service implements ApiProxy {
  static inject = [
    'agentDefaultModel', 'agents', 'attachments', 'directoryPicker', 'llm', 'mediaIntake', 'sessions', 'subagents', 'sessionQuery',
    'tools', 'usageStats', 'userQuestions', 'workspaceRegistry',
  ]
