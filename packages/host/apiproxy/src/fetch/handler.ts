...
import {
  ...
  hostPickDirectoryRequestSchema, hostTestProxyRequestSchema,
...
import { usageQueryRequestSchema } from '../api/usage.schema.ts'
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.testProxy': { schema: hostTestProxyRequestSchema, invoke: (api, r, signal) => api.host.testProxy(r, signal) },
  ...
  'usage.query': { schema: usageQueryRequestSchema, invoke: (api, r) => api.usage.query(r) },
}
