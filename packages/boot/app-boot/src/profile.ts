 ...
 * `dsh-host-directory-picker-auto` whose packages must be linked too;
...
export function healProfilesModuleFallback(installAnchor: string, home: string = resolveDshHome()): void {
  ...
  // names `dsh-host-directory-picker-auto`,
  // `dsh-host-directory-picker-auto`), and the re-rooted walk makes the bundle's
