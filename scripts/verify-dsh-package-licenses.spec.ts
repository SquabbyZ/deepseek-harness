...
describe('DSH package license gate', () => {
  it('checks root, dsh-root, and dsh-prefixed package names while ignoring other families', () => {
    const root = createWorkspace()
    writeManifest(root, 'packages/typert/dsh/package.json', { name: '@deepseek-ai/dsh', license: 'MIT' })
